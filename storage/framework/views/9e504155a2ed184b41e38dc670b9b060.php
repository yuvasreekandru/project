            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right;">
                        <a href="<?php echo e(route('brand.add')); ?>" class="btn btn-primary">Add New Brand</a>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Desktop\project\resources\views/admin/brand/list.blade.php ENDPATH**/ ?>