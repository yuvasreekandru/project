                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="name" value="<?php echo e(!empty(Auth::user()->name) ? Auth::user()->name : ''); ?>"
                                ...
                                <input type="text" name="address_one" value="<?php echo e(!empty(Auth::user()->address_one) ? Auth::user()->address_one : ''); ?>" class="form-control"
                                    placeholder="House number and Street name" required>
                                <input type="text" name="address_two" value="<?php echo e(!empty(Auth::user()->address_two) ? Auth::user()->address_two : ''); ?>" class="form-control"
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="postcode" value="<?php echo e(!empty(Auth::user()->postcode) ? Auth::user()->postcode : ''); ?>" class="form-control" required>
                                    </div><!-- End .col-sm-6 -->
                                ...
                                <input type="email" name="email" value="<?php echo e(!empty(Auth::user()->email) ? Auth::user()->email : ''); ?>" class="form-control" required>
                            ...
                            <aside class="col-lg-3">
                                <div class="summary">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = Cart::content(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> $<?php echo e(number_format($cart->price * $cart->qty, 2)); ?></td>
                                                </tr>
                                                    ...
                                                    <td>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" required
                                                                id="free-shipping<?php echo e($shipping->id); ?>" name="shipping"
                                                                value="<?php echo e($shipping->id); ?>"
                                                                data-price="<?php echo e(!empty($shipping->price) ? $shipping->price : 0); ?>"
                                                                class="custom-control-input getShippingCharge">
                                                            <label class="custom-control-label"
                                                                for="free-shipping<?php echo e($shipping->id); ?>"><?php echo e($shipping->name); ?></label>
                                                        </div><!-- End .custom-control -->
                                                    </td>
                                                    <td>
                                                        <?php if(!empty($shipping->price)): ?>
                                                            <?php echo e(number_format($shipping->price, 2)); ?>
                                            ...
                                            <tr class="summary-total">
                                                <td> Total:</td>
                                                <td>$ <span
                                                        id="getPayableTotal"><?php echo e(number_format(Cart::subtotal(), 2)); ?></span>
                                                </td>
                                    ...
                                    <input type="hidden" id="PayableTotal"
                                        value="<?php echo e(number_format(Cart::subtotal(), 2)); ?>">
                                    <div class="accordion-summary" id="accordion-payment">
                                        <?php if(!empty($getPaymentSetting->is_cash_delivery)): ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if(!empty($getPaymentSetting->is_paypal)): ?>
                                            <div class="custom-control custom-radio" style="margin-top:0px;">
                                        ...
                                        <?php endif; ?>
                                        <?php if(!empty($getPaymentSetting->is_stripe)): ?>
                                            <div class="custom-control custom-radio" style="margin-top:0px;">
                                    ...
                                    <br><br>
                                    <img src="<?php echo e(asset('molla/assets/images/payments-summary.png')); ?>"
                                        alt="payments cards">
                                </div><!-- End .summary -->
                            </aside><!-- End .col-lg-3 -->
                        </div><!-- End .row -->
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        $('body').delegate('#applyDiscount', 'click', function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(url('checkout/apply_discount_code')); ?>",
                data: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Desktop\project\resources\views/payment/checkout.blade.php ENDPATH**/ ?>