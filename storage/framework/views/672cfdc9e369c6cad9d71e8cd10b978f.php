                    ...
                    <div class="col-12 col-sm-6 col-md-2">
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">$<?php echo e(number_format($TotalAmount, 2)); ?></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-12 col-sm-6 col-md-2">
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">$<?php echo e(number_format($TotalTodayAmount, 2)); ?></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <select class="form-control changeYear" style="width:100px;" id="">
                                        <?php for($i = 2022; $i <= date('Y'); $i++): ?>
                                            <option <?php echo e($year == $i ? 'selected' : ''); ?> value="<?php echo e($i); ?>">
                                                <?php echo e($i); ?></option>
                                        <?php endfor; ?>
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(asset('AdminLTE/plugins/dist/js/pages/dashboard3.js')); ?>"></script>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Desktop\project\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>