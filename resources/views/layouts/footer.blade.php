            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="widget widget-about">
                        <img src="{{ asset('molla/assets/images/logo-footer.png') }}" class="footer-logo" alt="Footer Logo"
                            width="105" height="25">
    ...
    <div class="footer-bottom">
        <div class="container">
            ...
            <figure class="footer-payments">
                <img src="{{ asset('molla/assets/images/payments.png') }}" alt="Payment methods" width="272"
                    height="20">
